...
class MYPDF extends TCPDF
{
    ...
    {
        $image_file = dirname(__FILE__) . '/assets1/images/logo2.jpg';
        $this->Image($image_file, 10, 20, 40, '', 'JPG', '', 'T', false, 500, '', false, false, 0, false, false, false);
...
$pdf->Ln(20);
$html = '
<br><h1 align="center">RESUMEN DE MI PEDIDO<hr class="hr-1"></h1>
<style>
hr {
