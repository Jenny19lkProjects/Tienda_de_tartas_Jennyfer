...
if (isset($_POST["accion"]) && $_POST["accion"] == "addCar") {
    ...
    // Obtener el precio desde el POST, ya sea precio o precio2
    if (isset($_POST['precio'])) {
        $precio = $_POST['precio'];  // Cuando se selecciona Mediano
    } else if (isset($_POST['precio2'])) {
        $precio = $_POST['precio2'];  // Cuando se selecciona Grande
