...
/**
 * Funcion para obtener todos los productos y las valoraciones 
 * de mi tienda
 */

function getProductData_Valoracion($con)
{
    $sqlProducts = ("
        SELECT 
            p.id AS prodId,
        ...
        return '
            <div class="row align-items-center">
                ...
                <div class="col-lg-12 text-center mt-5 mb-5">
                    <a href="inicio_tartas.php" class="red_button btn_raza" style="padding: 5px 20px;">
...
function totalAcumuladoDeuda($con)
{
    if (isset($_SESSION['tokenStoragel']) != "") {
        ...
        return  number_format($dataDeuda['totalPagar'], 2, ',', '.');
    }
}
